return {
	...
	config = function()
		...
		set({ "n", "x" }, "<leader>k", function()
			mc.matchAddCursor(-1)
		end, { desc = "Add cursor by match" })
		set({ "n", "x" }, "<leader>j", function()
			mc.matchAddCursor(1)
		end, { desc = "Add cursor by match" })
		set({ "n", "x" }, "<leader>K", function()
			mc.matchSkipCursor(-1)
		end, { desc = "Skip cursor by match" })
		set({ "n", "x" }, "<leader>J", function()
			mc.matchSkipCursor(1)
		end, { desc = "Skip cursor by match" })
		...
		set("n", "<c-leftdrag>", mc.handleMouseDrag, { desc = "Handle mouse drag for cursors" })
		set("n", "<c-leftrelease>", mc.handleMouseRelease, { desc = "Handle mouse release for cursors" })
		...
		mc.addKeymapLayer(function(layerSet)
			...
			layerSet({ "n", "x" }, "<leader>q", mc.deleteCursor, { desc = "Delete main cursor" })
